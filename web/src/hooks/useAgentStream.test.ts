...
const mockRuntime = (streams: Record<string, any>) => ({
  phase: 'idle', prompt_tokens: 0, output_tokens: 0,
  cache_hit_tokens: 0, cache_miss_tokens: 0, context_pct: 0,
  current_iter: 0, content_deltas: 0, active_delegations: 0,
  total_agents: 0, running_agents: 0, idle_agents: 0, total_errors: 0,
  http_addr: ':8765', agent_streams: streams,
})
