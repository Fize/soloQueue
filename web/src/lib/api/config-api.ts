...
export async function updateModelRoutes(data: ModelRoutesConfig): Promise<ModelRoutesConfig> {
  return request<ModelRoutesConfig>('/config/model-routes', {
    method: 'PUT',
    body: JSON.stringify(data),
  })
...
export async function updateQQBotsConfig(data: QQBotConfig[]): Promise<QQBotConfig[]> {
  return request<QQBotConfig[]>('/config/qqbots', {
    method: 'PUT',
    body: JSON.stringify(data),
  })
...
export async function cancelWeChatLogin(sessionId: string): Promise<void> {
  return request<void>(`/channels/wechat/login/${encodeURIComponent(sessionId)}`, {
    method: 'DELETE',
  })
}
...
export async function updateSpeechConfig(data: SpeechConfig): Promise<SpeechConfig> {
  return request<SpeechConfig>('/config/speech', {
    method: 'PUT',
    body: JSON.stringify(data),
  })
