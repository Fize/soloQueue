...
export function ChatPage() {
  ...
  // mount that races ahead of backend readiness gets a second chance once
  // the health poll reports the backend is up — same pattern as SessionTree.
  // Without this, the welcome-screen selectors stay empty
