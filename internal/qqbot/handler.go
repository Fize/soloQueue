...
// PendingMedia represents a rich media file to be uploaded/sent.
type PendingMedia struct {
	FileType   int    // 1: image, 2: video, 3: voice, 4: file
	URL        string // public URL
	Base64Data string // Base64 representation of file content
}
...
type AskStreamResult struct {
	...
	ImageURLs        []string       // image URLs generated by ImageGenerate tool (deprecated, kept for backwards compatibility)
	MediaList        []PendingMedia // list of general media attachments to send
}
