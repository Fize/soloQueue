...
<div class="direction-card">
  ...
  <div class="feature-grid">
    ...
    <div class="feature-item"><strong>材质与光影</strong><span>[分析]</span></div>
  ...
  <div class="gallery">
    <div class="gallery-item">
      <img src="[图片URL]" alt="[作品名]" loading="lazy" onerror="this.src='data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%22200%22 height=%22180%22><rect fill=%22%23f0f0f5%22 width=%22200%22 height=%22180%22/><text x=%2250%%22 y=%2250%%22 text-anchor=%22middle%22 dy=%22.3em%22 fill=%22%23999%22 font-size=%2214%22>图片加载失败</text></svg>'">
      <div class="caption">
        [作品名]
        <span class="source">来自 <a href="[作品URL]" target="_blank" rel="noopener">[平台名]</a></span>
      </div>
    </div>
    <!-- 重复 3-5 个案例 -->
  </div>
