---
name: brand-strategy-methodology
description: "End-to-end brand visual identity design methodology — a six-stage workflow from brand detective to system architect. Covers brand soul discovery, visual strategy, creative exploration, system building, multi-touchpoint narration, and guardian delivery."
when_to_use: "Trigger when the user mentions: brand identity design, brand guidelines, visual identity system, logo design, brand strategy, brand vision"
---

# Brand Strategy Methodology — Six-Stage Workflow

Full-cycle brand visual identity system design process. Each stage has a distinct role mindset, deliverables, and quality gates.
